    ...
    <div className='w-full p-1 px-2 rounded-lg bg-cartitem flex items-center gap-2'>
       <img src={item?.imageURL} className='w-20 h-20 max-w-[60px] rounded-full object-contain' alt='' />
        ...
        <div className='flex flex-col gap-2'>
           ...
           <p className='text-sm block text-gray-300 font-semibold'>{parseFloat(item?.price) * qty}kr</p>
        </div>
        {/*Button section */}
        <div className='griup flex items-center gap-2 mi-auto cursor-pointer'>
